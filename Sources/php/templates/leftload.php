<div class="row">
    <div class="main-left col-8 col-tab-12">  
        ...
        <?php
            ...
            $theloai = "SELECT movie.movieID, `movieName`, `movieNation`, `movieYear`, `movieTime`, `movieNumber`, `groupID`, `image`, `Link`,`movieContent` FROM `movie`,`link` where groupID ='$groubID' and movie.movieID=link.movieID and link.number=1 limit 0,12";
